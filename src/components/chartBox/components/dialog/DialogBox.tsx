...
function DialogBox({
    ...
    setNumberOfChannels: (v: number) => void
    loadSavedData: () => void
}) {
    const [numberOfChannelsLocal, setNumberOfChannelsLocal] =
        useState(numberOfChannels)
    ...
    return (
        ...
        >
            ...
            <DialogContent>
                <DialogContentText>
                    Input the number of channels you want to have, or load
                    charts already saved
                </DialogContentText>
            </DialogContent>
            <div className="input">
                <CustomNumberInput
                    value={numberOfChannelsLocal}
                    editValue={setNumberOfChannelsLocal}
